...
--
-- Host: 127.0.0.1:3306
-- Generation Time: May 31, 2023 at 11:25 PM
...
(35, 42, 10225, '2023-06-01 06:53:08', '1,0,0,3 GA'),
(36, 42, 10244, '2023-06-01 06:53:25', '2.34.1');
...
(32, 81, 10248, '2023-06-01 06:12:24', '2.31.24.1'),
(33, 81, 10226, '2023-06-01 06:13:43', '3.0.0.0.0 GA'),
(34, 1, 10225, '2023-06-01 06:26:10', '1,0,0,3 GA'),
(37, 82, 10248, '2023-06-01 07:12:43', '3.0.0.0 GA'),
(38, 82, 10229, '2023-06-01 07:13:00', '4.0.0.0.0');
...
) ENGINE=InnoDB AUTO_INCREMENT=10257 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
...
(10225, 'Apache Hadoop2', 'Apache Hadoop software is an open source framework that allows for the distributed storage and processing of large datasets across clusters of computers using simple programming models. Hadoop is designed to scale up from a single computer to thousands of clustered computers, with each machine offering local computation and storage. In this way, Hadoop can efficiently store and process large datasets ranging in size from gigabytes to petabytes of data.', 'MIT License', 66, NULL, 'https://hadoop.apache.org/docs/stable/', 1, 42, '2023-05-31 14:53:06', '2023-05-31 09:48:58'),
(10226, 'Apache Kajka', 'Apache Kafka is a distributed data store optimized for ingesting and processing streaming data in real-time. Streaming data is data that is continuously generated by thousands of data sources, which typically send the data records in simultaneously. A streaming platform needs to handle this constant influx of data, and process the data sequentially and incrementally.', 'Apache License 2.0', 27, NULL, 'https://kafka.apache.org/', 1, 42, '2023-05-31 14:14:39', '2023-05-31 09:49:38'),
(10227, 'Apache Sparks', 'Apache Spark is a data processing framework that can quickly perform processing tasks on very large data sets, and can also distribute data processing tasks across multiple computers, either on its own or in tandem with other distributed computing tools. These two qualities are key to the worlds of big data and machine learning, which require the marshalling of massive computing power to crunch through large data stores. Spark also takes some of the programming burdens of these tasks off the shoulders of developers with an easy-to-use API that abstracts away much of the grunt work of distributed computing and big data processing. From its humble beginnings in the AMPLab at U.C. Berkeley in 2009, Apache Spark has become one of the key big data distributed processing frameworks in the world. Spark can be deployed in a variety of ways, provides native bindings for the Java, Scala, Python, and R programming languages, and supports SQL, streaming data, machine learning, and graph processing. You’ll find it used by banks, telecommunications companies, games companies, governments, and all of the major tech giants such as Apple, IBM, Meta, and Microsoft.', 'LGPL', 212, NULL, 'https://spark.apache.org/', 1, 42, '2023-05-31 15:23:30', '2023-05-31 09:50:36'),
...
(10229, 'Matplot++', 'Data visualization can help programmers and scientists identify trends in their data and efficiently communicate these results with their peers. Modern C++ is being used for a variety of scientific applications, and this environment can benefit considerably from graphics libraries that attend the typical design goals toward scientific data visualization. Besides the option of exporting results to other environments, the customary alternatives in C++ are either non-dedicated libraries that depend on existing user interfaces or bindings to other languages. Matplot++ is a graphics library for data visualization that provides interactive plotting, means for exporting plots in high-quality formats for scientific publications, a compact syntax consistent with similar libraries, dozens of plot categories with specialized algorithms, multiple coding styles, and supports generic backends.', 'MIT License', 130, NULL, 'https://alandefreitas.github.io/matplotplusplus/', 1, 42, '2023-05-31 15:23:29', '2023-05-31 09:53:30'),
...
(10232, 'ggplot', 'ggplot2 is a system for declaratively creating graphics, based on The Grammar of Graphics. You provide the data, tell ggplot2 how to map variables to aesthetics, what graphical primitives to use, and it takes care of the details.', 'MIT License', 754, NULL, 'https://ggplot2.tidyverse.org/reference/', 1, 55, '2023-05-31 15:11:35', '2023-05-31 10:09:17'),
...
(10255, 'NewWonder', 'A machine learning package that simplifies the setup of ML projects.', 'Apache License', 3, NULL, 'www.github.com/muhammad/new-wonder', 1, 81, '2023-05-31 14:26:46', '2023-05-31 14:22:11'),
(10256, 'WonderML', 'WonderML is an innovative programming module designed by programmers for programmers.', 'MIT License', 4, NULL, 'www.github.com/muhmmad/wonderML', 1, 82, '2023-05-31 15:19:34', '2023-05-31 15:16:55');
...
(170, 10243, 81, 3, 'Steep learning curve', '2023-05-31 22:17:11', '2023-05-31 22:17:11'),
(171, 10248, 82, 4, 'This is a great library! But a bit confusing', '2023-05-31 23:12:35', '2023-05-31 23:12:35');
...
('Iuwg0hTXJyOSRDbBGjS2aVz8GyG9rlpBS1L8yp1O', NULL, '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/113.0.0.0 Safari/537.36', '', 1685575409),
('kjfX4PcCF2GKPLsJFSLeZJJ8708FejaHnLZlj6tF', 81, '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/113.0.0.0 Safari/537.36 Edg/113.0.1774.57', '', 1685575410),
('ZcHHfC1PiTMfi1Ff30i6l6hpQNcj7ix1O3mAlsei', NULL, '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/113.0.0.0 Safari/537.36', 'YTozOntzOjY6Il90b2tlbiI7czo0MDoiVWtLSUd5eUgwSkhEd2RtMnFOZGl2SThDRW1IWVJyMHIySDZKSGxtQiI7czo2OiJfZmxhc2giO2E6Mjp7czozOiJvbGQiO2E6MDp7fXM6MzoibmV3IjthOjA6e319czo5OiJfcHJldmlvdXMiO2E6MTp7czozOiJ1cmwiO3M6MjY6Imh0dHA6Ly9sb2NhbGhvc3Q6ODAwMC9ob21lIjt9fQ==', 1685575488);
...
(31, 81, '\'s Team', 1, '2023-05-31 14:11:59', '2023-05-31 14:11:59'),
(32, 82, '\'s Team', 1, '2023-05-31 15:12:09', '2023-05-31 15:12:09');
...
(42, 'techlover77', 'techlover77@example.com', NULL, '$2y$10$cmJLzBRDuY0BXdZVds6N.ee7oDe/R/3ZFsb2PSeDCmsmDcuLJwO7.', NULL, NULL, NULL, NULL, NULL, NULL, '2023-05-31 09:29:11', '2023-05-31 14:23:29', 0, 3),
...
(81, 'FakeTestUser', 'FakeTestUser@gmail.com', NULL, '$2y$10$JST6NqlFY2zAPXOgb21avOrjNGYDInKN0J19Z1wL2UoCXWqc/ykSq', NULL, NULL, NULL, NULL, NULL, NULL, '2023-05-31 14:11:59', '2023-05-31 14:11:59', 0),
(82, 'NewUserVideo', 'NewUserVideo@exampleEmail.com', NULL, '$2y$10$I1imuL2VGigWdoMjANtfou1n5mNkMzy4jdhlvrJdiINVuRQMspNSG', NULL, NULL, NULL, NULL, NULL, NULL, '2023-05-31 15:12:09', '2023-05-31 15:17:53', 0);
...
(157, 10226, '3.0.0.0.0 GA', 'Stable Release', '2023-05-31 14:14:20', '2023-05-31 14:14:20', 'rar'),
(159, 10248, '3.0.0.0 GA', 'Stable Release', '2023-05-31 15:10:26', '2023-05-31 15:10:26', 'rar'),
(160, 10229, '4.0.0.0.0', 'Bugfix Patch', '2023-05-31 15:13:50', '2023-05-31 15:13:50', 'rar');
...
(158, 10255, '1.0.0.0 GA', 'Stable Release', '2023-05-31 14:22:11', '2023-05-31 14:22:11', 'rar'),
(161, 10256, '1.0.0.0.0', 'Stable Release', '2023-05-31 15:16:55', '2023-05-31 15:16:55', 'rar'),
(162, 10256, '2.0.0.0.0', 'Added Features', '2023-05-31 15:17:21', '2023-05-31 15:17:21', 'rar');
